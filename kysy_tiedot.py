...
while True: # Ikuinen silmukka, jossa ollaan kunnes annetaan tyhjä pituus
    ...
    #Yritetaan muuttaa syötetyt tekstit luvuiksi ja laskea BMI
    try:
    ...
    #jos tapahtuu virhe, ilmoitetaan kayttajölle    
...
for henkilo in bmi_lista:
    ...
    #Monikossa on kaksi tietoa, joiden indeksit ovat 0(ensimäinen) ja 1(toinen)
